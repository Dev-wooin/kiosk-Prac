...
public class Product extends Menu {
    ...
    ////Burgers
//    static Product shackBurger = new Product("ShackBurger",6.9,"토마토, 양상추, 쉑소스가 토핑된 치즈버거");
//    static Product smokeShack = new Product("SmokeShack", 8.9, "베이컨, 체리 페퍼에 쉑소스가 토핑된 치즈버거");
//    static Product shroomBurger = new Product("ShroomBurger", 9.4, "몬스터 치즈와 체다 치즈로 속을 채운 베지테리안 버거");
//    static Product cheeseBurger = new Product("Cheeseburger", 6.9, "포테이토 번과 비프패티, 치즈가 토핑된 치즈버거");
//    static Product hamburger = new Product("Hamburger", 5.4, "비프패티를 기반으로 야채가 들어간 기본버거");
//
//    ////Frozen Custard
//    static Product shakes = new Product("Shakes", 5.9, "바닐라, 초콜렛, 솔티드카라멜, 블랙&화이트, 스트로베리, 피넛버터, 커피");
//    static Product shakeOfTheWeek = new Product("Shake of the week", 6.5, "특별한 커스터드 플레이버");
//    static Product redBeanShake = new Product("Red Bean Shake", 6.5, "신선한 커스터드와 함께 우유와 레드빈이 블렌딩된 시즈널 쉐이크");
//    static Product floats = new Product("Floats", 5.9, "루트 비어, 퍼플 카우, 크림시클");
//
//    //// Drinks
//    static Product shackMadeLemonade = new Product("Shack-made Lemonade", 3.9, "매장에서 직접 만드는 상큼한 레몬에이드");
//    static Product freshBrewedIcedTea = new Product("Fresh Brewed Iced Tea", 3.4,"직접 유기농 홍차를 우려낸 아이스티");
//    static Product fiftyFifty = new Product("Fifty/Fifty",3.5,"레몬에이드와 아이스티의 만남");
//
//    ////Beer
//    static Product shackMeisterAle = new Product("ShackMeister Ale", 9.8, "쉐이크쉑 버거를 위해 뉴욕 브루클린 브루어리에서 특별히 양조한 에일 맥주");
//    static Product magpieBrewingCo = new Product("Magpie Brewing Co.", 6.8,"맥파이 브루잉에서 특별히 제조한 맥주");
